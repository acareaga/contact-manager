...
describe 'the person view', type: :feature do
  ...
  describe 'the phone numbers view' do
    ...
    it 'has a link to add a new phone number' do
      expect(page).to have_link('Add phone number', href: new_phone_number_path(contact_id: contact, contact_type: 'Person'))
    end
  ...
  describe 'the email addresses view' do
    before(:each) do
      person.email_addresses.create(address: "johnsmith@gmail.com")
      person.email_addresses.create(address: "janedoe@gmail.com")
      visit person_path(person)
    end
  ...
  xit 'deletes a email address' do
    email = person.email_addresses.first
    old_email = email.address
